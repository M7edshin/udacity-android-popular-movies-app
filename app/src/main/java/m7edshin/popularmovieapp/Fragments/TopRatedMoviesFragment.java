...
/**
 * Created by M7edS on 08/03/2018.
 * Top Rated Movies Fragment implementation
 */

public class TopRatedMoviesFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<MovieDetails>> {
